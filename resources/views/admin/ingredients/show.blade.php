...
@section('content')
    ...
    <section class="content-header flex justify-between">
        <h1 class="mt-2">
            Products contain {{ $ingredient->name }}
            <small>View</small>
        </h1>
        <div>
            <a href="{{ route('admin.ingredients.index') }}"
                class="btn btn-primary font-bold inline-block items-center relative block pl-8"><i
                    class="fas fa-backward fa-xs absolute top-3 left-3"></i> Back To Ingredients</a>
        </div>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="card">
            <div class="card-body shadow">
                <livewire:admin.ingredients-product-data-table :ingredientID="$ingredient->id" :ingredientName="$ingredient->name"/>
            </div>
        </div>
    </section>
@endsection
