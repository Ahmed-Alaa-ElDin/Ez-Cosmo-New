            ...
            <div class="card-body shadow">
                ...
                <table id="lines" class="table table-bordered w-100 text-center">
                    ...
                    <tbody class="align-middle">
                        @forelse ($indication->products as $product)
                            <tr>
                            ...
                            <tr>
                                <td colspan="8">
                                    There's No Products for <span class='font-bold'>" {{ $indication->name }} "</span>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
