<div>
    ...
    <div class="flex justify-center">
        <div>
            <a href="{{ route('admin.ingredientsproduct.exportExcel', $ingredientID) }}"
                class="btn btn-success btn-sm font-bold"><i class="fas fa-file-excel"></i> &nbsp; Excel</a>
            <a href="{{ route('admin.ingredientsproduct.exportPDF', $ingredientID) }}"
    ...
    <table class="table table-bordered w-100 text-center">
        ...
        <tbody class="align-middle">
            ...
            @empty
                <tr>
                    <td colspan="8">
                        There's No Products Contain <span class='font-bold'>" {{ $ingredientName }} "</span>
                    </td>
                </tr>
            @endforelse
        </tbody>
