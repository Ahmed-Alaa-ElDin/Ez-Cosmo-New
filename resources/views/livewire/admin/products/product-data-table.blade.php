                ...
                <tr>
                    ...
                    <td class="align-middle">
                        ...
                        <button type="button" class="btn btn-sm btn-danger font-bold deleteButton"
                            data-name='{{ $product->name }}' data-id='{{ $product->id }}' data-toggle="modal"
                            data-target="#DeleteModal" wire:click="load('{{ $product->id }}')"><i class="fas fa-trash-alt"></i></button>
                    </td>
                </tr>
            @endforeach
        </tbody>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            {{-- Reviews --}}
                                            <div class="col-lg-12 mb-2">
                                                @livewire('admin.review', ['product_id' => $this->product_id],key($this->product_id))
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    Are You Sure, You Want To Delete '<span id="deletedItemName" class="font-bold">{{ $name }}</span>' ?
                </div>
                <div class="modal-footer flex justify-between">
                    <button type="button" class="btn btn-secondary font-bold" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger font-bold" data-dismiss="modal" wire:click = 'deleteProduct({{ $product_id }})'>Delete</button>
                </div>
            </div>
        </div>
    </div>
