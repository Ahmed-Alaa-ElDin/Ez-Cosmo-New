                    ...
                    <td class="align-middle">
                        <div class="min-w-max">
                            <button type="button" class="btn btn-sm btn-primary font-bold detailsButton"
                                ...
                                wire:click="load('{{ $product->id }}')"><i class="far fa-eye"></i></button>
                            <a href="{{ route('admin.products.edit', $product->id) }}"
                                class="btn btn-sm btn-info font-bold"><i class="fas fa-edit"></i></a>
                            <button type="button" class="btn btn-sm btn-success font-bold restoreButton"
                                wire:click="restoreProduct('{{ $product->id }}')"><i class="fa fa-undo"></i></button>
                            <button type="button" class="btn btn-sm btn-danger font-bold deleteButton"
                                data-toggle="modal" data-target="#DeleteModal"
                                wire:click="load('{{ $product->id }}')"><i class="fas fa-trash-alt"></i></button>
                        </div>
                    </td>
                </tr>
            @empty
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-2">
                                                ...
                                                $this->product_id],key($this->product_id))
                                            </div>
                                        </div>
                                    </div>
                                </div>
