<div>
    ...
    <div class="flex justify-center">
        <div>
            <a href="{{ route('admin.countriesuser.exportExcel', $countryID) }}"
                class="btn btn-success btn-sm font-bold"><i class="fas fa-file-excel"></i> &nbsp; Excel</a>
            <a href="{{ route('admin.countriesuser.exportPDF', $countryID) }}"
    ...
    <table id="users" class="table table-bordered w-100 text-center">
        ...
        <tbody class="align-middle">
            @forelse ($users as $user)
                ...
                <tr>
                    <td colspan="7">
                        No Users From <strong>"{{ $countryName }}"</strong>
    ...
    <div class="flex justify-between">
        <div>
            Showing {{ $users->firstItem() ?? '0' }} to {{ $users->lastItem() }} of
            {{ $users->total() }}
            entries
        </div>
        <div>
