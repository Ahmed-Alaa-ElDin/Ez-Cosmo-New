<div>
    ...
    <div class="flex justify-center">
        <div>
            <a href="{{ route('admin.lines.exportExcel') }}" class="btn btn-success btn-sm font-bold"><i
                    class="fas fa-file-excel"></i> &nbsp; Excel</a>
            <a href="{{ route('admin.lines.exportPDF') }}" class="btn btn-danger btn-sm font-bold"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    Are You Sure, You Want To Delete '<span id="deletedItemName"
                        class="font-bold">{{ $line_name }}</span>' ?
                </div>
