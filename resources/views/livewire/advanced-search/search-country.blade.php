<div>
    <div class="form-group relative w-50 max-h-36 mx-auto z-10">
        <input type="text" id="searchInput" class="z-20 shadow focus:outline-none focus:ring focus:border-green-300 form-control rounded text-center"
            wire:model.debounce.300ms='countrySearch' wire:keydown.escape='resetData' wire:keydown.arrow-up="goUp"
            wire:keydown.arrow-down="goDown" wire:keydown.enter="selectCountry"
            placeholder="Type the Country Name" autofocus>
                        ...
                        <div class="card-body">
                            ...
                            <div class="details-button text-center">
                                <button type="button" data-toggle="modal" data-target="#DetailsModal"
                                    ...
                                    class="btn btn-success btn-sm w-max">More Details</button>
                            </div>
                        </div>
                    </div>
                @empty
    ...
    <div class="modal fade bd-example-modal-xl" id="DetailsModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success font-bold">
                    <h5 class="modal-title text-white" id="datailsModalCenterTitle">Product's Details</h5>
