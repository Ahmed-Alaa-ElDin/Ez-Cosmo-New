...
class CategoriesProductDataTable extends Component
{
    use WithPagination;
    ...
    public $product_name, $categoryID, $categoryName;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.categories.categories-product-data-table', compact('products'));
    }

    public function query()
    {
        return Product::select('products.*', 'lines.id As line_id', 'brands.name As brand_name', 'forms.name As form_name', 'categories.name As category_name', 'categories.id As category_id')
