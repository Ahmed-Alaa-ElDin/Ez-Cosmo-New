...
class CountriesProductDataTable extends Component
{
    use WithPagination;
    ...
    public $product_name, $countryID, $countryName;
    public $name, $product_id, $origin = "";
    public $category, $brand, $line, $directions, $form, $notes, $advantages, $disadvantages, $countrie, $volume, $units, $price, $code = "";
    ...
    public function render()
    {
        ...
        return view('livewire.admin.countries.countries-product-data-table', compact('products'));
    }
