...
class IndicationsProductDataTable extends Component
{
    use WithPagination;
    ...
    public $product_name, $indicationID, $indicationName;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.indications.indications-product-data-table', compact('products'));
    }

    public function query()
    {
        return Product::select('products.*','indications.name As indications_name','indications.id As indications_id', 'indication_product.indication_id', 'indication_product.product_id', 'lines.name As line_name', 'brands.name As brand_name', 'forms.name As form_name', 'categories.name As category_name')
