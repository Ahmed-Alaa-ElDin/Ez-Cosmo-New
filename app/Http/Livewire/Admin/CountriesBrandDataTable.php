...
class CountriesBrandDataTable extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.countries.countries-brand-data-table', compact('brands'));
    }
    ...
    public function query()
    {
        return Brand::select('brands.*', 'countries.name As country_name')
            ...
            ->where('brands.country_id', $this->countryID)
